...
MASK_CH_ID = 0b111100000000000 # 0x7800
SHIFT_CH_ID = 1
MASK_SERVO_POS_HIGH = 0b11111111111 # 0x07FF
...
try:
    ...
    while True:
        ...
        sys.stdout.write(
            "    %4d     %4d     %4d     %4d     %4d     %4d	%4d	%4d	%4d	%4d\r"%tuple(servo_position[:10]))
	#sys.stdout.write(servo_position)
